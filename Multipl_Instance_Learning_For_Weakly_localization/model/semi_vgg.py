...
class Semi_VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        # class
        logits = self.linear_cls(base.view(base.size(0), 512 * 8 * 8))
    ...
    def cal_element_loss(self, largest_norm_grad, cam):
        ...
        sigmoid = nn.Sigmoid()
        return cam_loss(sigmoid(upsample_cam.view(upsample_cam.size(0), -1)), largest_norm_grad.view(largest_norm_grad.size(0), -1))
